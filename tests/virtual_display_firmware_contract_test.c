...
int main(void)
{
    ...
    assert(VirtualDisplayValidateGeometry(1280, 800, 5120, 32));
    assert(!VirtualDisplayValidateGeometry(0, 800, 5120, 32));
    assert(!VirtualDisplayValidateGeometry(1280, 800, 5119, 32));
    assert(!VirtualDisplayValidateGeometry(1280, 800, 5120, 30));

    assert(VirtualDisplayValidateFramebufferRange(
        UINT64_C(0x85f000000), UINT64_C(0x3e8000),
        UINT64_C(0x850000000), UINT64_C(0x1af708000)));
    assert(!VirtualDisplayValidateFramebufferRange(
        0, UINT64_C(0x3e8000), UINT64_C(0x850000000), UINT64_C(0x1af708000)));
    assert(!VirtualDisplayValidateFramebufferRange(
        UINT64_C(0x85f000000), 0, UINT64_C(0x850000000), UINT64_C(0x1af708000)));
    assert(!VirtualDisplayValidateFramebufferRange(
        UINT64_MAX - UINT64_C(0x1000), UINT64_C(0x2000), 0, UINT64_MAX));
    assert(!VirtualDisplayValidateFramebufferRange(
        UINT64_C(0x84f000000), UINT64_C(0x3e8000),
        UINT64_C(0x850000000), UINT64_C(0x1af708000)));
    assert(!VirtualDisplayValidateFramebufferRange(
