...
class GuestLayoutGenerationTests(unittest.TestCase):
    ...
    def test_checked_in_outputs_are_generated_from_the_canonical_layout(self):
        ...
        self.assertEqual(layout.virtual_fb_width, 2560)
        self.assertEqual(layout.virtual_fb_height, 1600)
        self.assertEqual(layout.virtual_fb_stride, 10240)
        self.assertEqual(layout.virtual_fb_size, 0xFA0000)
